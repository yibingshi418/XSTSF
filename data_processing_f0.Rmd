...
desired_order <- c('speaker', 'token', 'diortri', 'focus_condition', 'focus_no', 'citation_tone', 'sandhi_tone', 'syllable_no',  'citation_no', 'ind_no', 'sync_tone1', 'sync_tone2', 'sync_tone3', 'hist_tone1', 'hist_tone2', 'hist_tone3', 'syntax', 'time', 'f0', 'norm_f0')
...
f0_all_pre <- plyr::rbind.fill(f0_mono_pre, f0_di_ct_pre, f0_tri_ct_pre, f0_di_focus_pre, f0_tri_focus_pre) %>%
  ...
  # add perceptual sandhi categories
  select(!sandhi_tone) %>% 
