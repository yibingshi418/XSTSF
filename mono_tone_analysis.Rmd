...
## Average contours
The plot below shows the f0 contours of the 4 non-checked tones across all the 8 speakers. The solid lines are average contours, and the faint lines are individual contours for each token.

```{r out.width='50%', out.height='300px', message=FALSE}
...
2. double click the tone category in the legend on the top to visualise this category only. 
...
2. S7's HL tone is not measured accurately using the Praat Script [*ProsodyPro*](https://www.homepages.ucl.ac.uk/~uclyyix/ProsodyPro/).  
3. S8 almost produced every tone with a falling end, so his tones seem to be merging.
